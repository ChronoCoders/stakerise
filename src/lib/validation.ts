...
export const kycDocumentSchema = z.object({
  document_type: z.enum(['passport', 'drivers_license', 'national_id', 'proof_of_address']),
...
export const unstakeFormSchema = z.object({
  stakeIndex: z.number(),
  acceptPenalty: z.boolean().refine(val => val === true, 'You must accept the early unstaking penalty')
});
