      ...
      <CardContent className="pt-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <div className="p-4 rounded-lg bg-muted/50">
            ...
            <p className="text-2xl font-semibold">{SAMPLE_STATS.totalReferrals}</p>
          </div>
          <div className="p-4 rounded-lg bg-muted/50">
            <p className="text-sm text-muted-foreground mb-1">Total Earnings</p>
            <p className="text-2xl font-semibold">${SAMPLE_STATS.totalEarnings}</p>
          </div>
        </div>
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              <Button
                variant="outline"
                size="icon"
                onClick={() => copyToClipboard(SAMPLE_STATS.referralCode, 'code')}
              >
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              <Button
                variant="outline"
                size="icon"
                onClick={() => copyToClipboard(SAMPLE_STATS.referralLink, 'link')}
              >
                <Copy className="w-4 h-4" />
              </Button>
            </div>
