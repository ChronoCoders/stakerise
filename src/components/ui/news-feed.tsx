...
const SAMPLE_NEWS: NewsItem[] = [
  {
    ...
    summary:
      "New features including improved staking analytics and enhanced security measures",
    category: "update",
    date: "2025-03-15",
  },
  {
    ...
    summary:
      "StakeRise token now available for trading on leading cryptocurrency exchange",
    category: "token",
    date: "2025-03-14",
  },
  {
    ...
    summary:
      "New staking tiers and reward structure approved by community vote",
    category: "community",
    date: "2025-03-13",
  },
];
