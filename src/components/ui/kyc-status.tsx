...
import { FileUp as FileUpload, UserCheck, AlertTriangle, Clock, CheckCircle2, XCircle } from 'lucide-react';
import { kycService, VerificationStatus, DocumentType } from '@/lib/kyc-service';
...
export function KYCStatus() {
  ...
  const [selectedDocType, setSelectedDocType] = React.useState<DocumentType>('passport');
    ...
    <Card>
      <CardContent className="pt-6">
        <div className="flex items-center justify-between mb-6">
          ...
          <span className={`text-sm font-medium ${STATUS_COLORS[status]} capitalize`}>
            {status.replace('_', ' ')}
          </span>
        </div>
                ...
                <div className="space-y-2">
                  {documents.map((doc: any) => (
                    ...
                    >
                      ...
                      <span className={`text-sm font-medium ${STATUS_COLORS[doc.verification_status]} capitalize`}>
