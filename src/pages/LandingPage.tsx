        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Secure, flexible, and rewarding staking platform for your digital
              assets. Earn up to 18% APY on your favorite cryptocurrencies.
            </p>
            <Button
              size="lg"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection>
            ...
            <p className="text-center text-muted-foreground mb-16 max-w-2xl mx-auto">
              ...
              Longer staking periods offer higher rewards and lower early
              unstaking penalties.
            </p>
          </AnimatedSection>
            ...
            {[
              {
                ...
                description:
                  "Enterprise-grade security with multi-signature wallets and regular audits",
              },
              {
                icon: Clock,
                title: "Flexible Duration",
                description:
                  "Choose from 6, 12, or 24-month staking periods with competitive rewards",
              },
              {
                icon: Coins,
                title: "STR Token",
                description:
                  "Stake STR tokens and earn rewards through our innovative platform",
              },
              {
                icon: TrendingUp,
                title: "High APY",
                description: "Earn up to 18% APY with our tiered reward system",
              },
            ].map((feature, index) => (
            ...
            {[
              {
                ...
                description:
                  "Link your Web3 wallet to get started with staking",
              },
              {
                step: 2,
                title: "Choose Your Plan",
                description: "Select your preferred staking duration",
              },
              {
                step: 3,
                title: "Start Earning",
                description:
                  "Watch your rewards grow with competitive APY rates",
              },
            ].map((item, index) => (
            ...
            {[
              {
                ...
                description:
                  "Regular reward distributions directly to your wallet",
              },
              {
                icon: Users,
                title: "Community Driven",
                description: "Active community with governance participation",
              },
              {
                icon: Globe2,
                title: "Global Access",
                description: "Available worldwide with 24/7 staking support",
              },
              {
                icon: Lock,
